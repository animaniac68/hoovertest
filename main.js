...
//var dirt1 = readInput[2].split(/[ ,]+/);
//var dirt2 = readInput[3].split(/[ ,]+/);
//var dirt3 = readInput[4].split(/[ ,]+/);
...
// 	switch (dirtbuster) {
// 		case 'E':
// 			hoover.position[0] = hoover.position[0]
//       + 1;
// 			break;}
//       //Stop();
//        RegisterTravelLogMovement();
...
myGrid[dirt.a[0]][dirt.a[1]] = 'D';
myGrid[dirt.b[0]][dirt.b[1]] = 'D';
myGrid[dirt.c[0]][dirt.c[1]] = 'D';
